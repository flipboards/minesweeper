...
QT_MOC_LITERAL(1, 8, 13), // "ButtonGoClick"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "EndPage\0ButtonGoClick\0"
};
...
void EndPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        EndPage *_t = static_cast<EndPage *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ButtonGoClick(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject EndPage::staticMetaObject = {
    { &WindowPage::staticMetaObject, qt_meta_stringdata_EndPage.data,
      qt_meta_data_EndPage,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *EndPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_EndPage.stringdata0))
        return static_cast<void*>(const_cast< EndPage*>(this));
